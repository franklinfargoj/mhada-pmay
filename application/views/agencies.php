                         ...
                         <div class="m-portlet__head-tools">
                            <ul class="m-portlet__nav">
                                <li class="m-portlet__nav-item">
                                    ...
                                    <a data-toggle="modal" data-target="#add_agency" class="btn m-btn--pill btn-primary mb-3" style="float: right;">Add Agency</a></li>

                                <div class="modal fade" id="add_agency" tabindex="-1" role="dialog" aria-labelledby="addAgencyLabel" aria-hidden="true">
                           ...
                           <tr <?php echo $style_tr;?>>
                              ...
                              <td style="width:35%">
                                 <div class="button-group-custom">
                                        <a href="<?php echo base_url('agencies/view/'.base64_encode($this->encryption->encrypt($each_agent['id'])));?>"  class="mb-1 btn m-btn--pill btn-primary" style="color: white">View</a>
