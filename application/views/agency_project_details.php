                         ...
                         <div class="m-portlet__head-tools">
                             <ul class="m-portlet__nav">
                                 <li class="m-portlet__nav-item">
                                     <a class="btn m-btn--pill btn-primary mb-3" style="float: right;"  data-toggle="modal" data-target="#assign_project">Assign New Project</a>


                                     <div class="modal fade" id="assign_project" tabindex="-1" role="dialog" aria-labelledby="assignProjectLabel" aria-hidden="true">
                                         <div class="modal-dialog" role="document">
                                             <?php echo form_open(base_url('agencies/assign_project_to_agency/'),'method="post" id="add_agency_form"');?>
                                             <div class="modal-content">
                                                 <div class="modal-header">
                                                     <h5 class="modal-title" id="adduserLabel"><strong>Assign Project To Agency</strong></h5>
                                                 ...
                                                 <div class="modal-body" style="overflow-y: scroll; height:200px;">
                                                     <div class="form-group">
                                                         ...
                                                         <div class="form-group">
                                                             ...
                                                             <input type="hidden" name="agency_id" class="form-control" value="<?php echo $agency_details[0]['id']; ?>">
                                                         </div>
                                                     </div>
                                                     <div class="form-group">
                                                         ...
                                                         <div class="form-group">
                                                             <select id="project_ids" name="project_ids[]" multiple="multiple">
                                                                 <?php  foreach($projects_to_assign as $project) {  ?>
                                                                 <option value="<?php echo $project['id']; ?>" <?php if($project['agency_id']==$agency_details[0]['id']){ echo 'selected'; } ?> ><?php echo $project['title']; ?></option>
                                                                 <?php } ?>
                                                             </select>
                                                         </div>
                                                     </div>
                                         ...
                                         if(is_array($agency_project_details) && array_filter($agency_project_details))
                                         {
                                             foreach($agency_project_details as $count_scheme_serial => $agency_project)
                                             {
                                                 ...
                                                 <tr <?php echo $style_tr;?>>
                                                     ...
                                                     <td><?php echo $agency_project['code'];?></td>
                                                     <td><?php echo $agency_project['title'];?></td>
                                                     <td><?php echo $agency_project['district'];?></td>
                                                     <td><?php echo $agency_project['city'];?></td>
                                                     <td><?php echo date('F j, Y',strtotime($agency_project['csmc_meeting_date']));?></td>
                                                     <td style="width:35%">
                                                         <div class="button-group-custom">
                                                             <a href="<?php echo base_url('agencies/delete_project/'.base64_encode($this->encryption->encrypt($agency_project['id'])));?>"  class="mb-1 btn m-btn--pill btn-primary" style="color: white">Remove Project</a>
