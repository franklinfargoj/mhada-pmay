                                 ...
                                 <div class="m-portlet m_portlet_tools_project">
                                     ...
                                     <div class="m-portlet__body" style="margin-top: -5%;">
                                         ...
                                         <div class="row">
                                             <div class="col-lg-6">
                                                 <h5>EWS</h5>
                                                 <p><?php echo isset($started_work_dus[0]['EWS'])?$started_work_dus[0]['EWS']:'-';?></p>
                                             </div>

                                             <div class="col-lg-6">
                                                 <h5>LIG</h5>
                                                 <p><?php echo isset($started_work_dus[0]['LIG'])?$started_work_dus[0]['LIG']:'-';?></p>
                                             </div>
                                         </div>
                                         ...
                                         <div class="row">
                                             <div class="col-lg-6">
                                                 <h5>MIG</h5>
                                                 <p><?php echo isset($started_work_dus[0]['MIG'])?$started_work_dus[0]['MIG']:'-';?></p>
                                             </div>

                                             <div class="col-lg-6">
                                                 <h5>HIG</h5>
                                                 <p><?php echo isset($started_work_dus[0]['HIG'])?$started_work_dus[0]['HIG']:'-';?></p>
                                             </div>
                                         </div>

                                         <div class="row">
                                             <div class="col-lg-6">
                                                 <h5>Total DUs for which work is started</h5>
                                                 <p><?php echo isset($started_work_dus[0]['total_dus_work_started'])?$started_work_dus[0]['total_dus_work_started']:'-';?></p>
                                             </div>
...
<script>
    $(document).ready(function(){
        ...
        $("#save_stage").click(function(){
            ...
            $.ajax({
                type: "POST",
                url: "agency/save_stage_dus_details",
