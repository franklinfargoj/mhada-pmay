                             ...
                             <!-- <td><?php /*echo $each_project['address'];*/?></td>-->
                              ...
                              <td style="width:35%">
                                 <div class="button-group-custom">
                                     ...
                                     <a href="<?php echo base_url('agency/financial_details/'.base64_encode($this->encryption->encrypt($each_project['code'].'|'.$each_project['id'])));?>" class="mb-1 btn m-btn--pill btn-primary" style="color: white">Financial Details</a>
                                     </div>
