...
<div class="sidebar">
   <div class="sidebar-inner">
      ...
      <ul class="sidebar-menu scrollable pos-r">
         ...
         <li class="nav-item <?php if(current_url()==base_url('projects')  || $this->uri->segment(2)=='add_project' || ($this->uri->segment(1)=='projects' && $this->uri->segment(2)=='view') || $this->uri->segment(2)=='documents' || $this->uri->segment(2)=='photos' || $this->uri->segment(2)=='update_project_stage' || $this->uri->segment(2)=='financial_details') { ?> active <?php } ?>"><a class="sidebar-link" href="<?php echo base_url('projects');?>"><span class="icon-holder"><i class="c-red-500 ti-files"></i> </span><span class="title">Projects</span></a></li>
        ...
        <li class="nav-item <?php if(current_url()==base_url('masters') || ($this->uri->segment(1)=='masters') ) { ?> active <?php } ?>"><a class="sidebar-link" href="<?php echo base_url('masters');?>"><span class="icon-holder"><i class="c-orange-500 ti-layout-list-thumb"></i> </span><span class="title">Manage Masters</span></a></li>
